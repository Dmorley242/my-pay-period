...
export type Transaction = { id: string; date: string; transaction_type: "income" | "expense" | "deposit" | "withdrawal"; account_id: string; category_id: string | null; pay_period_id: string | null; amount: number; notes: string | null; budget_item_id?: string | null; budget_sub_item_id?: string | null; };
